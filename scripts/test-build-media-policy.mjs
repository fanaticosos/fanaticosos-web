...
const retainedId = "4d8d6017-651e-417f-968a-82a9b460376e";
const retainedAudio = [`audio/es-${retainedId}.mp3`, `audio/en-${retainedId}.mp3`];
...
assert.deepEqual(
  validateGeneratedMedia(["index.html", ...expectedAudio, retainedAudio[0]], releaseEnvironment),
  [
    `private release dist has an incomplete bilingual audio pair: audio/es-${retainedId}.mp3`,
  ],
);
assert.deepEqual(
