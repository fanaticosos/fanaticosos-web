...
try {
  ...
  for (const route of ["/api/participa", "/api/participa/config", "/api/participa/slots", "/api/admin/invitados", "/api/admin/invitados/action", "/api/admin/invitados/reserve", "/api/fan-map"]) {
